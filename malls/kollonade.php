<html lang="en">
  ...
  <body id="page-top">
          ...
          <div class="row justify-content-md-center">
            ...
            <div class="col-md-6 lcontent">
              ...
              <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action andSelected">Kollonade</a>
    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
          ...
          <div class="col-md-6 bcontent">
            ...
            <form id="kollonadeForm" name="kolDetails" novalidate>
            ...
            <div class="">
              ...
              <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        ...
                        <img class="img-responsive logoImg float-right" src="../img/logos/locksecure-checkers-hyper-client.png"/><label for="items1">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop1" value="Checkers Hyper">
              ...
              <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingFour" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/logo-dischem.jpg"/><label for="items2">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop2" value="Dis-chem Pharmacies">
              ...
              <div id="collapseSix" class="collapse" role="tabpanel" aria-labelledby="headingSix" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/game.jpg"/><label for="items3">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop3" value="Game">
    ...
    <script src="../js/malls/kollonade.js"></script>
