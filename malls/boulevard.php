<html lang="en">
  ...
  <body id="page-top">
          ...
          <div class="row justify-content-md-center">
            ...
            <div class="col-md-6 lcontent">
              ...
              <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action andSelected">Boulevard</a>
    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
          ...
          <div class="col-md-6 bcontent">
            ...
            <form id="boulevardForm" name="bouleDetails" novalidate>
            ...
            <div class="">
              ...
              <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="numOfShops" value="4">
              ...
              <div role="tab" id="headingTwo">
                  <a data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="list-group-item list-group-item-action text-center">Woolworths Food</a>
              </div>
              
              <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/G26-Woolworths-Logo.jpg"/><label for="items2">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop2" value="Woolworths Food">
              ...
              <div role="tab" id="headingThree">
                  <a data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="list-group-item list-group-item-action text-center">Liquor City</a>
              </div>
              
              <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/liquor-city-logo-2017.png"/><label for="items3">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop3" value="Liquor City">
          ...
          <br />
          <div class="form-group">
            <label for="cnumber">Custmer Number</label>
    ...
    <script src="../js/malls/boulevard.js"></script>
