<html lang="en">
  ...
  <body id="page-top">
          ...
          <div class="row justify-content-md-center">
            ...
            <div class="col-md-6 lcontent">
              ...
              <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action andSelected">Brooklyn</a>
    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
          ...
          <div class="col-md-6 bcontent">
            ...
            <form id="brooklynForm" name="brookDetails" novalidate>
            <div class="accordion list-group" role="tablist">
            <div class="">
              <div role="tab" id="headingOne">
                  <a data-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="list-group-item list-group-item-action text-center">Market Liquors</a>
              </div>
              
              <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="numOfShops" value="9">
                        <img class="img-responsive logoImg float-right" src="../img/logos/marketliq.png" alt="Market Liquors"/> <label for="items1">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop1" value="Market Liquors">
              ...
              <div role="tab" id="headingTwo">
                  <a data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="list-group-item list-group-item-action text-center">Checkers</a>
              </div>
              
              <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/locksecure-checkers.png"/><label for="items2">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop2" value="Checkers">
              ...
              <div role="tab" id="headingThree">
                  <a data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="list-group-item list-group-item-action text-center">Verimark</a>
              </div>
              
              <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/1892731_130809172109_verimark-logo.gif"/><label for="items3">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop3" value="Verimark">
              ...
              <div id="collapseNine" class="collapse" role="tabpanel" aria-labelledby="headingNine" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/foodlovers.jpg"/><label for="items7">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop7" value="Food Lovers Market">
              ...
              <div id="collapseTen" class="collapse" role="tabpanel" aria-labelledby="headingTen" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/clicks.jpg"/><label for="items8">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop8" value="Clicks Pharmacy">
              ...
              <div id="collapseEl" class="collapse" role="tabpanel" aria-labelledby="headingEl" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/cna.jpg"/><label for="items9">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop9" value="CNA">
    ...
    <script src="../js/malls/brooklyn.js"></script>
