<html lang="en">
  ...
  <body id="page-top">
          ...
          <div class="row justify-content-md-center">
            ...
            <div class="col-md-6 lcontent">
              ...
              <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action andSelected">Silver Orks</a>
    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
          ...
          <div class="col-md-6 bcontent">
            ...
            <form id="silverorksForm" name="silverDetails" novalidate>
            <div class="accordion list-group" role="tablist">
            <div class="">
              <div role="tab" id="headingOne">
                  <a data-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="list-group-item list-group-item-action text-center">SuperSpar</a>
              </div>
              ...
              <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <img class="img-responsive logoImg float-right" src="../img/logos/CSSLogo.png"/> <label for="items1">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop1" value="SuperSpar">
              ...
              <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/liquor-city-logo-2017.png"/><label for="items2">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop2" value="Liquor City">
              ...
              <div id="collapseFive" class="collapse" role="tabpanel" aria-labelledby="headingFive" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/G26-Woolworths-Logo.jpg"/><label for="items3">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop3" value="Woolworths Food">
    ...
    <script src="../js/malls/silverorks.js"></script>
