<html lang="en">
  ...
  <body id="page-top">
          ...
          <div class="row justify-content-md-center">
            ...
            <div class="col-md-6 lcontent">
              ...
              <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action andSelected">Centurion</a>
    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
          ...
          <div class="col-md-6 bcontent">
            ...
            <form id="centurionForm" name="cenDetails" novalidate>
            ...
            <div class="">
              ...
              <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="numOfShops" value="8">
              ...
              <div role="tab" id="headingTwe">
                  <a data-toggle="collapse" href="#collapseTwe" aria-expanded="false" aria-controls="collapseTwe" class="list-group-item list-group-item-action text-center">Woolworths Food</a>
              </div>
              ...
              <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingFour" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/logo-dischem.jpg"/><label for="items6">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop6" value="Dis-chem Pharmacies">
                        <textarea class="form-control" id="items6" rows="3"></textarea>
                      </div>
                </div>
              </div>

              <div role="tab" id="headingThre">
                  <a data-toggle="collapse" href="#collapseThre" aria-expanded="false" aria-controls="collapseThre" class="list-group-item list-group-item-action text-center">Verimark</a>
              </div>
              
              <div id="collapseThre" class="collapse" role="tabpanel" aria-labelledby="headingThre" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/1892731_130809172109_verimark-logo.gif"/><label for="items7">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop7" value="Verimark">
              ...
              <div role="tab" id="headingAte">
                  <a data-toggle="collapse" href="#collapseAte" aria-expanded="false" aria-controls="collapseAte" class="list-group-item list-group-item-action text-center">Checkers Hyper</a>
              </div>
              
              <div id="collapseAte" class="collapse" role="tabpanel" aria-labelledby="headingAte" data-parent="#accordion">
                <div class="card-body">
                      <div class="form-group">
                        <img class="img-responsive logoImg float-right" src="../img/logos/locksecure-checkers-hyper-client.png"/><label for="items8">Grocery List</label>
                        <input type="hidden" class="form-control" id="shop8" value="Checkers Hyper">
    ...
    <script src="../js/malls/centurion.js"></script>
