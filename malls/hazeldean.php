<html lang="en">
  ...
  <body id="page-top">
          ...
          <div class="row justify-content-md-center">
            ...
            <div class="col-md-6 lcontent">
              ...
              <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action andSelected">Hazeldean Square</a>
    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
          ...
          <div class="col-md-6 bcontent">
            ...
            <form id="hazeldeanForm" name="hazDetails" novalidate>
            ...
            <div class="">
              ...
              <div role="tab" id="headingTen">
                  <a data-toggle="collapse" href="#collapseTen" aria-expanded="false" aria-controls="collapseNine" class="list-group-item list-group-item-action text-center">Dis-chem Pharmacies</a>
              </div>
              ...
              <div role="tab" id="headingEl">
                  <a data-toggle="collapse" href="#collapseEl" aria-expanded="false" aria-controls="collapseEl" class="list-group-item list-group-item-action text-center">Woolworths Food</a>
              </div>
    ...
    <script src="../js/malls/hazeldean.js"></script>
